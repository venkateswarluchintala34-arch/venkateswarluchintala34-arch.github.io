...
<section class="section soft"><div class="wrap">
  <div class="mission reveal">
    ...
    <p class="mission-text">Обеспечивать промышленность <b>собственной, надёжной и экономичной энергией</b> — проектируя, строя и обслуживая энергоцентры под ключ, чтобы предприятия снижали затраты на энергоресурсы и развивали производство, не отвлекаясь на вопросы энергоснабжения.</p>
  </div>
</div></section>
<section class="stats-band"><div class="wrap">
  <div class="stat reveal"><b>100+ МВт</b><span>реализованной мощности</span></div>

...
SERVICES = [
 ...
 dict(k="kotelnye", p="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.07-2.14-.22-4.05 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.15.43-2.29 1-3a2.5 2.5 0 0 0 2.5 2.5Z", kind="path",
  ...
  img="kotelnaya-6mvt-duo.jpg",
  spec='''<div class="spec"><h4>Параметры</h4>
        <div class="spec-row"><b>Паровые котлы</b><span>0,5–30 т/ч</span></div>
        <div class="spec-row"><b>Водогрейные котлы</b><span>0,5–30 МВт</span></div>
        <div class="spec-row"><b>Топливо</b><span>газ · дизель · мазут</span></div>
        <div class="spec-row"><b>Исполнение</b><span>БМК · стационарные</span></div></div>'''),
 dict(k="btp", p="M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z", kind="path",
  ...
  img="btp-duo.jpg",
  spec='''<div class="spec"><h4>Параметры</h4>
        <div class="spec-row"><b>Тепловая нагрузка</b><span>до 20 МВт</span></div>
        <div class="spec-row"><b>Контуры</b><span>отопление · ГВС · вентиляция</span></div>
        <div class="spec-row"><b>Регулирование</b><span>погодозависимое · ЧРП</span></div>
        <div class="spec-row"><b>Исполнение</b><span>блочное, заводской готовности</span></div></div>'''),
 dict(k="kompressornye", p="M12 14l4-4|M3.34 19a10 10 0 1 1 17.32 0", kind="path",
  ...
  img="kompressornaya-duo.jpg", img2="kompressornaya-duo-2.jpg",
  spec='''<div class="spec"><h4>Параметры</h4>
        <div class="spec-row"><b>Тип компрессоров</b><span>винтовые · центробежные</span></div>
        <div class="spec-row"><b>Рабочее давление</b><span>6–13 бар</span></div>
        <div class="spec-row"><b>Удельный расход</b><span>95–120 кВт·ч/1000 м³</span></div>
        <div class="spec-row"><b>Качество воздуха</b><span>по ISO 8573-1</span></div></div>'''),
 dict(k="nasosnye", p="M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5s-3.5-4-4-6.5c-.5 2.5-2 4.9-4 6.5C6 11.1 5 13 5 15a7 7 0 0 0 7 7z", kind="path",
  ...
  img="real/ks-2.jpg",
  spec='''<div class="spec"><h4>Параметры</h4>
        <div class="spec-row"><b>Назначение</b><span>ХВС/ГВС · пожаротушение · техсреды</span></div>
        <div class="spec-row"><b>Подача и напор</b><span>под задачу объекта</span></div>
        <div class="spec-row"><b>Регулирование</b><span>ЧРП · каскад</span></div>
        <div class="spec-row"><b>Исполнение</b><span>блочно-модульное</span></div></div>'''),
 dict(k="oborotnoe", p="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.71-3.19S7.29 4.24 7 2c-.29 2.24-1.15 3.13-2.29 4.06S3 8.91 3 10.05c0 2.22 1.8 4.05 4 4.05z|M12.56 6.6A11 11 0 0 0 14 3c.5 2.5 2 4.9 4 6.5s3 3.5 3 5.5a7 7 0 0 1-11.9 5", kind="path",
  ...
  img=None,
  spec='''<div class="spec"><h4>Параметры</h4>
        <div class="spec-row"><b>Градирни</b><span>вентиляторные · эжекционные</span></div>
        <div class="spec-row"><b>Контур</b><span>замкнутый оборотный</span></div>
        <div class="spec-row"><b>Автоматика</b><span>стабилизация температуры</span></div>
        <div class="spec-row"><b>Реконструкция</b><span>рост холодопроизводительности</span></div></div>'''),
 dict(k="ventilyaciya", p="M10.83 16.38a6.08 6.08 0 0 1-8.62-7l5.41 1.45a6.08 6.08 0 0 1 7-8.62l-1.45 5.41a6.08 6.08 0 0 1 8.62 7l-5.41-1.45a6.08 6.08 0 0 1-7 8.62l1.45-5.41Z|M12 12v.01", kind="path",
  ...
  img=None,
  spec='''<div class="spec"><h4>Параметры</h4>
        <div class="spec-row"><b>Тип</b><span>приточно-вытяжная · аспирация</span></div>
        <div class="spec-row"><b>Рекуперация</b><span>до 70% тепла</span></div>
        <div class="spec-row"><b>Дополнительно</b><span>дымоудаление · кондиционирование</span></div>
        <div class="spec-row"><b>Сервис</b><span>балансировка, пусконаладка</span></div></div>'''),
 dict(k="holodosnabzhenie", p="M12 2v20|M2 12h20|m4.9 4.9 14.2 14.2|m19.1 4.9-14.2 14.2", kind="path",
  ...
  img=None,
  spec='''<div class="spec"><h4>Параметры</h4>
        <div class="spec-row"><b>Оборудование</b><span>чиллеры · холодильные машины</span></div>
        <div class="spec-row"><b>Мощность</b><span>под задачу (до нескольких МВт)</span></div>
        <div class="spec-row"><b>Контур</b><span>гидромодули · аккумуляторы холода</span></div>
        <div class="spec-row"><b>Режим</b><span>технология / климат / тригенерация</span></div></div>'''),
 dict(k="ekologiya", p="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z|M2 21c0-3 1.85-5.36 5.08-6", kind="path",
  ...
  img=None,
  spec='''<div class="spec"><h4>Параметры</h4>
        <div class="spec-row"><b>Оборудование</b><span>рукавные/электрофильтры · циклоны · скрубберы</span></div>
        <div class="spec-row"><b>Производительность</b><span>под задачу</span></div>
        <div class="spec-row"><b>Эффект</b><span>выбросы до нормативов</span></div>
        <div class="spec-row"><b>Дополнительно</b><span>возврат уловленного сырья</span></div></div>'''),
 dict(k="truboprovody", p="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z", kind="path",
  ...
  img=None,
  spec='''<div class="spec"><h4>Параметры</h4>
        <div class="spec-row"><b>Среды</b><span>пар · вода · газ · масло · агрессивные</span></div>
        <div class="spec-row"><b>Работы</b><span>сварка (аттест.) · механомонтаж</span></div>
        <div class="spec-row"><b>Объём</b><span>эстакады · внутрицеховая разводка</span></div>
        <div class="spec-row"><b>Приёмка</b><span>испытания · изоляция</span></div></div>'''),
 dict(k="elektromontazh", p="M12 22v-5|M9 8V2|M15 8V2|M18 8v5a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V8Z", kind="path",
  ...
  img=None,
  spec='''<div class="spec"><h4>Параметры</h4>
        <div class="spec-row"><b>КТП</b><span>комплектные трансформаторные подстанции</span></div>
        <div class="spec-row"><b>РУ / РЗА</b><span>распредустройства, релейная защита</span></div>
        <div class="spec-row"><b>Сети</b><span>кабельные · электромонтаж</span></div>
        <div class="spec-row"><b>Пусконаладка</b><span>электроизмерения</span></div></div>'''),
 dict(k="co2", p="M17.7 7.7a2.5 2.5 0 1 1 1.8 4.3H2|M9.6 4.6A2 2 0 1 1 11 8H2|M12.6 19.4A2 2 0 1 0 14 16H2", kind="path",
  ...
  img=None,
  spec='''<div class="spec"><h4>Параметры</h4>
        <div class="spec-row"><b>Источник</b><span>дымовые газы котельных / ГПУ</span></div>
        <div class="spec-row"><b>Продукт</b><span>пищевой / технический CO₂</span></div>
        <div class="spec-row"><b>Чистота</b><span>до 99,9%</span></div>
        <div class="spec-row"><b>Интеграция</b><span>энергоцентр / котельная</span></div></div>'''),
 dict(k="gazoluchistoe", p="M12 2v2M12 20v2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M2 12h2M20 12h2M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4", kind="sun",
  ...
  img=None,
  spec='''<div class="spec"><h4>Параметры</h4>
        <div class="spec-row"><b>Тип</b><span>светлые / тёмные ИК-излучатели</span></div>
        <div class="spec-row"><b>Топливо</b><span>природный / сжиженный газ</span></div>
        <div class="spec-row"><b>Высота помещений</b><span>от 4 м</span></div>
        <div class="spec-row"><b>Экономия газа</b><span>до 30–50% против воздушного отопления</span></div></div>'''),
 dict(k="osveschenie", p="M9 18h6M10 22h4M12 2a7 7 0 0 0-4 12.7c.6.5 1 1.3 1 2.1V17h6v-.2c0-.8.4-1.6 1-2.1A7 7 0 0 0 12 2z", kind="path",
  ...
  img="real/osveshchenie-1.jpg",
  spec='''<div class="spec"><h4>Параметры</h4>
        <div class="spec-row"><b>Тип</b><span>LED цехов · территорий · аварийное</span></div>
        <div class="spec-row"><b>Экономия</b><span>до 50–70% против ДРЛ/ДНаТ</span></div>
        <div class="spec-row"><b>Управление</b><span>диспетчеризация, датчики</span></div>
        <div class="spec-row"><b>Расчёт</b><span>по нормам освещённости (СП)</span></div></div>'''),
 dict(k="askue", p="M22 12h-4l-3 9L9 3l-3 9H2", kind="path",
  ...
  img=None,
  spec='''<div class="spec"><h4>Параметры</h4>
        <div class="spec-row"><b>Ресурсы</b><span>электроэнергия · тепло · газ · вода</span></div>
        <div class="spec-row"><b>Уровень</b><span>узлы учёта + SCADA</span></div>
        <div class="spec-row"><b>Режим</b><span>мониторинг и управление 24/7</span></div>
        <div class="spec-row"><b>Эффект</b><span>снижение затрат 10–15%</span></div></div>'''),
]
...
# ---- ПРОЕКТЫ ----
PROJECTS=[
 ("energocentr-3d-duo.jpg","Энергоцентр 13,5 МВт","Энергосервис (ЭСК)","13,5 МВт · утилизация тепла · автономный режим","Два энергоцентра (6 и 7,5 МВт) для федерального инфраструктурного заказчика по энергосервисной схеме: без капзатрат заказчика, оплата из фактической экономии. Утилизация тепла двигателей, работа в автономном режиме."),
 ("real/ural-gpu-2.jpg","Энергоцентр 6 МВт","Когенерация","6 МВт · параллель с сетью · трубный газ","Три рабочих ГПУ и резерв, параллель с сетью на трубном газе, утилизация тепла в когенерации. Реализация и оплата из экономии."),
 ("real/atmosfera-1.jpg","Оборотное водоснабжение","Автозавод","+30–40% охлаждения · 2024–2026","Реконструкция системы оборотного водоснабжения крупного автомобильного завода: градирни, насосные станции, обвязка. Рост холодопроизводительности на 30–40%."),
 ("kompressornaya-duo.jpg","Компрессорные станции","Автозавод","до 1800 м³/ч · −20–30% энергозатрат","Модернизация компрессорных станций крупного автозавода: винтовые и центробежные компрессоры, осушка, управление по нагрузке. Снижение энергозатрат на сжатый воздух до 30%."),
 ("kompressornaya-duo-2.jpg","Аспирация и газоочистка","Литейное производство","до 1,2 млн м³/ч · экология","Система аспирации и пылегазоочистки чугунолитейного производства производительностью до 1,2 млн м³/ч. Снижение выбросов до нормативных значений."),
 ("real/ks-1.jpg","Технологические трубопроводы","Химпроизводство","аммиак · 1340 т/сут","Механомонтаж и трубопроводная обвязка агрегата по производству аммиака мощностью 1340 т/сут в кооперации с мировым лицензиаром технологии."),
 ("real/ks-2.jpg","Вентиляция и холодоснабжение","Машиностроение","3×2 МВт холода · 375 000 м³/ч","Промышленная вентиляция и станция холодоснабжения корпуса машиностроительного завода: три чиллера по 2 МВт, воздухообмен до 375 000 м³/ч."),
 ("kotelnaya-6mvt-duo.jpg","Паровая котельная","Промпредприятие","пар · автоматизация","Строительство и автоматизация котельной промышленного предприятия: котлы, ХВО, обвязка и диспетчеризация с работой без постоянного персонала."),
 ("btp-duo.jpg","АСКУЭ и диспетчеризация","Промплощадки","−10–15% энергозатрат","Автоматизированный учёт энергоресурсов и диспетчеризация инженерных систем нескольких промышленных площадок. Прозрачный учёт и снижение затрат на 10–15%."),
 ("real/osveshchenie-1.jpg","Инженерные системы","Торговая сеть","холод · вентиляция · освещение","Холодоснабжение, вентиляция и освещение сети гипермаркетов: комплексная реализация под ключ и дальнейший сервис."),
]
...
<section class="section" style="padding-top:0"><div class="wrap"><div class="grid g-3">{proj_cards}</div>
  <p style="text-align:center;color:var(--muted);margin-top:32px;font-size:15px">Названия заказчиков не раскрываются по условиям соглашений. Характеристики приведены по реализованным объектам.</p>
</div></section>

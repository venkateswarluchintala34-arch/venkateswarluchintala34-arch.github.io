...
# ---- ПРОЕКТЫ ----
PROJECTS=[
 ("energocentr-3d-duo.jpg","Энергоцентр 13,5 МВт по энергосервису","—","13,5 МВт · утилизация тепла · автономный режим","Два энергоцентра (6 и 7,5 МВт) для федерального инфраструктурного заказчика по энергосервисной схеме: без капзатрат заказчика, оплата из фактической экономии. Утилизация тепла двигателей, работа в автономном режиме."),
 ("real/ural-gpu-2.jpg","Энергоцентр на ГПУ","—","6 МВт · энергосервис · когенерация","Три рабочих ГПУ и резерв, параллель с сетью на трубном газе, утилизация тепла в когенерации. Реализация и оплата из экономии."),
 ("real/atmosfera-1.jpg","Оборотное водоснабжение автозавода","—","+30–40% охлаждения · 2024–2026","Реконструкция системы оборотного водоснабжения крупного автомобильного завода: градирни, насосные станции, обвязка. Рост холодопроизводительности на 30–40%."),
 ("kompressornaya-duo.jpg","Компрессорные станции автозавода","—","до 1800 м³/ч · −20–30% энергозатрат","Модернизация компрессорных станций крупного автозавода: винтовые и центробежные компрессоры, осушка, управление по нагрузке. Снижение энергозатрат на сжатый воздух до 30%."),
 ("kompressornaya-duo-2.jpg","Аспирация и газоочистка литейного производства","—","до 1,2 млн м³/ч · экология","Система аспирации и пылегазоочистки чугунолитейного производства производительностью до 1,2 млн м³/ч. Снижение выбросов до нормативных значений."),
 ("real/ks-1.jpg","Технологические трубопроводы азотного производства","—","аммиак · 1340 т/сут","Механомонтаж и трубопроводная обвязка агрегата по производству аммиака мощностью 1340 т/сут в кооперации с мировым лицензиаром технологии."),
 ("real/ks-2.jpg","Вентиляция и холодоснабжение машзавода","—","3×2 МВт холода · 375 000 м³/ч","Промышленная вентиляция и станция холодоснабжения корпуса машиностроительного завода: три чиллера по 2 МВт, воздухообмен до 375 000 м³/ч."),
 ("kotelnaya-6mvt-duo.jpg","Котельная промышленного предприятия","—","пар · автоматизация","Строительство и автоматизация котельной промышленного предприятия: котлы, ХВО, обвязка и диспетчеризация с работой без постоянного персонала."),
 ("btp-duo.jpg","АСКУЭ и диспетчеризация промплощадок","—","−10–15% энергозатрат","Автоматизированный учёт энергоресурсов и диспетчеризация инженерных систем нескольких промышленных площадок. Прозрачный учёт и снижение затрат на 10–15%."),
 ("real/osveshchenie-1.jpg","Инженерные системы торговой сети","—","холод · вентиляция · освещение","Холодоснабжение, вентиляция и освещение сети гипермаркетов: комплексная реализация под ключ и дальнейший сервис."),
]
